...
describe('signOut()', () => {
  it('success', () => {
    ...
    expect(saga.next().value).toEqual(call(deleteTokenFromStorage));
  ...
  it('failure', () => {
    ...
    expect(saga.throw(error).value).toEqual(put({ type: 'SIGN_OUT_ERROR', error }));
  ...
  it('watcher', () => {
    ...
    expect(watcher.next().value).toEqual(takeEvery('SIGN_OUT_REQUEST', signOut));
