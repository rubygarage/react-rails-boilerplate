...
import response from '../__mocks__/responses/signin';
...
describe('signIn()', () => {
  ...
  it('success', () => {
    ...
    expect(saga.next(normalizedResponse).value)
      .toEqual(call(setTokenToStorage, response.data.headers));
  ...
  it('watcher', () => {
    ...
    expect(watcher.next().value).toEqual(takeEvery('SIGN_IN_REQUEST', signIn));
