class Auth::Concepts::Session::Operation::Create < Trailblazer::Operation
  success :set_user!
  step Contract::Build(constant: Auth::Concepts::Session::Contract::Create)
  step Contract::Validate()
  step :set_token!
  step :set_response_auth_headers!

  def set_user!(options, params:, **)
    options['model'] = Auth::Models::User.find_by(username: params[:username])
  end
